...
Empty Trash does nothing when Trash is empty; otherwise it delegates to Finder immediately on click. Cancellation shows no message. Allow Finder Automation in System Settings → Privacy & Security → Automation if prompted. No login item is installed.
